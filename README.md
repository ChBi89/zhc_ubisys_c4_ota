# zhc_ubisys_c4_ota
external converter that can temporarily be used in zigbee2mqtt to allow OTA updates even when no OTA cluster is published

I used this to update my C4 devices from 2.5.0 to 2.6.1
